		...
		<div class="centercontent">
	        <div id="contentwrapper" class="contentwrapper">
		        <div id="validation" class="subcontent">
					...
					<form class="stdform stdform2"  enctype="multipart/form-data" id="newAddForm" method="post" action="admin/newUpdateSave">
                        ...
                        <p>
                            <label>速览图片<span class="inputrequiredflag">*</span>
                                ...
                                <input type="hidden"  name="deleteylIds" id="deleteylIds"/>       
                             <span class="p_image">
                               <span  class="imagefield">
                                 <input style="visibility:hidden;width:10px;"  type="file" name="ylfile" id="ylfile1"  multipleaccept="image/*" onchange="handleFiles('yl',this,1)" />
                                 <img id="ylimg1" src="${imgath}" />
                                 <strong class="image_delete_btn" onclick="deleteFile('yl',this,${imageId})"  title="删除">x</strong>
                               </span>
                           
                                <img style="display:none;"class="image_add_btn" id="yl_add_btn" src="images/add_image_btn.png" onclick="addFileInput(this,'yl');"/>
                            </span>                 
                       </p>
                        <p>
		                	<label>标题<span class="inputrequiredflag">*</span></label>
		                    <span class="field"><input type="text" placeholder="请输入信息标题" value="${news.title}" style="width:1024px;" name="title" required/></span>
		                </p>
                        <p>
		                	<label>简述<span class="inputrequiredflag">*</span></label>
		                    <span class="field"><input type="text" placeholder="请输入信息简述" value="${news.description}" style="width:1024px;" name="description" required/></span>
		                </p>
		                <p>
